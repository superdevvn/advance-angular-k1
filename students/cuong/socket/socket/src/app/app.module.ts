...
import { OrderDetailComponent } from './home/order/order-detail.component';
...
@NgModule({
  ...
  providers: [ApiService, loginService, CustomerService, CookieService, LoadingService,
    ...
    ProductService, ManufacturerService, UnitService, RoleService, UserService, SocketService],
